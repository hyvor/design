...
<p>
	Action List is a list of actions. It is primarily used with <a href="dropdown">Dropdowns</a>.
...
<Table columns="2fr 2fr 4fr">
	...
	<TableRow>
		...
		<div>
			Whether the item is selected or not. Only works when the <code>selection</code>
...
<p>
	...
	<code>on:select</code>
	events of the <code>{'<ActionListItem>'}</code> component to manage the selected item.
</p>
...
<CodeResult white>
	<ActionList selection="single">
		<ActionListItem selected={x1 === 1} on:select={() => (x1 = 1)}>Option 1</ActionListItem>
		<ActionListItem selected={x1 === 2} on:select={() => (x1 = 2)}>Option 2</ActionListItem>
		<ActionListItem selected={x1 === 3} on:select={() => (x1 = 3)}>Option 3</ActionListItem>
	</ActionList>
</CodeResult>
...
<CodeResult white>
	<ActionList selection="single" selectionAlign="end">
		<ActionListItem selected={x11 === 1} on:select={() => (x11 = 1)}>Option 1</ActionListItem>
		<ActionListItem selected={x11 === 2} on:select={() => (x11 = 2)}>Option 2</ActionListItem>
		<ActionListItem selected={x11 === 3} on:select={() => (x11 = 3)}>Option 3</ActionListItem>
	</ActionList>
</CodeResult>
