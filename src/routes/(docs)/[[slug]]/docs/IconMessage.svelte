...
<p>
    Icon Message is a component that can be used to show a message with an icon
...
<p>
    Icon Message has two templates: <code>empty</code> and <code>error</code>.
    You can use them by setting <code>empty</code> or <code>error</code> prop to
    <code>true</code>.
</p>
