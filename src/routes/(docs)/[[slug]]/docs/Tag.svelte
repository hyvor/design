...
<p>
  The <code>{"<Tag>"}</code> component is used to display a a category, a label,
  or a status.
</p>
...
<Table columns="1fr 1fr 2fr">
  ...
  <TableRow>
    ...
    <div><code>false</code></div>
    <div>
      Used with <code>outline</code>. Set to <code>true</code> to use the outline
      fill style.
    </div>
  </TableRow>

  <TableRow>
    <div><code>interactive</code></div>
    <div><code>false</code></div>
    <div>
      Set to <code>true</code> to make the tag interactive (hover effect and pointer
      cursor).
    </div>
  </TableRow>
  ...
  <TableRow>
    ...
    <div></div>
    <div>Custom background color</div>
  </TableRow>
...
<h3 id="outline-style">Outline style</h3>
...
<h3 id="outline-fill-style">Outline fill style</h3>
...
<CodeResult white>
  <div style="margin-bottom: 10px;">
    ...
    <Tag size="x-small" color="blue">
      <IconHourglass slot="start" size={10} />
      Scheduled
    </Tag>
  </div>
  ...
  <div style="margin-bottom: 10px;">
    ...
    <Tag size="small" color="green">
      <IconCheck slot="start" size={14} />
      Published
    </Tag>
    <Tag size="small" color="blue">
      <IconHourglass slot="start" size={11} />
      Scheduled
    </Tag>
  </div>
  ...
  <div style="margin-bottom: 10px;">
    ...
    <Tag size="large" color="green">
      <IconCheck slot="start" size={16} />
      Published
    </Tag>
    <Tag size="large" color="blue">
      <IconHourglass slot="start" size={14} />
      Scheduled
    </Tag>
...
<CodeResult>
  <Tag>
    Loading
    <Loader size="small" slot="end" colorTrack="transparent" />
  </Tag>
</CodeResult>
...
<p>
  Set the <code>interactive</code> property to <code>true</code> to add a hover effect
...
<p>
  You can use the <code>bg</code> and <code>fg</code> properties to set custom background
  and text colors.
</p>
...
<CodeResult white>
  <Tag bg="var(--green-light)" fg="var(--green)">Custom</Tag>
</CodeResult>
