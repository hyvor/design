...
<p>
  ...
  the source code on
  <a href="https://github.com/hyvor/design" target="_blank">Github</a>. However,
  it is not recommended to use HDS on non-HYVOR projects as it is not designed
  to be a general-purpose UI library.
</p>
...
<ul>
  ...
  <li>
    Font: <a href="https://fonts.bunny.net/family/readex-pro" target="_blank"
      >Readex Pro</a
    >
    (via
...
<ul>
  <li>
    <code>--accent</code> - The accent color of the product. Used for buttons, links,
    etc. Must be a dark color to be used with white text.
  </li>
  <li>
    <code>--accent-light</code> - A lighter version of the accent color. Used for
    hover effects. Must be a light color to be used with dark text.
  </li>
  <li>
    <code>--accent-lightest</code> - A very light version of the accent color. Used
    for backgrounds. Must be closer to white.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Import icons from <code>@hyvor/icons</code>. See <a href="#icons">Icons</a> below
...
<p>
  ...
  available in the <code>@hyvor/icons</code> package. In addition to general SVG
  attributes, the svelte component supports <code>size</code> to set the width and
  height of the icon.
</p>
