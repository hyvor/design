...
<p>
  This page introduces a few helper components that can be used to create form
  controls.
</p>
...
<p>
  These components are used in the <a href="/split-control">Split Control</a>
  component along with other components like
  <a href="/text-input">Text Input</a>, <a href="/checkbox">Checkbox</a>, etc.
</p>

<h2 id="label">Label and Caption</h2>
...
<p>
  The <code>{"<FormControl>"}</code> component can be used to wrap label, caption,
  validation, and other inputs. It will automatically add spacing between the elements.
</p>
...
<p>
  The <code>{"<InputGroup>"}</code> component can be used to group multiple inputs
  together. It will automatically add spacing between the elements. It can be used
  to group checkboxes, radio buttons, text inputs, etc.
</p>
