...
<p>
  The <code>{"<NavLink>"}</code> component is used in navigation (ex: in
  Console). All additional properties are sent directly to the underlying HTML
  <code>{"<a>"}</code> element.
</p>
    ...
    <Box style="width:100%">
      <div style="padding: 15px 0">
        ...
        >
          <IconCoin slot="start"></IconCoin>
          Billing
          <IconExclamationCircle slot="end" style="color:var(--orange)"
          ></IconExclamationCircle>
        </NavLink>
      </div>
    </Box>
