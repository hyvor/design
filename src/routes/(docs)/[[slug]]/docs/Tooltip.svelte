...
<p>Tooltips are small textual hints displayed when a user hovers over a UI element.</p>
...
<Table columns="2fr 2fr 3fr">
	...
	<TableRow>
		...
		<div></div>
		<div>The text to display in the tooltip.</div>
	</TableRow>
...
<Table columns="1fr 3fr">
	...
	<TableRow>
		...
		<div>The content that triggers the tooltip when hovered over.</div>
	</TableRow>
	<TableRow>
		<div><code>tooltip</code></div>
		<div>
			The content of the tooltip. This can be used instead of the <code>text</code> prop.
		</div>
	</TableRow>
</Table>
...
<p>
	You can use the <code>tooltip</code> slot to add advanced content to the tooltip.
</p>
...
<p>
	By default, the maximum width of the tooltip is set to <code>300px</code>. If the text is longer
	than this, it will wrap to the next line. You can change this value by setting the
