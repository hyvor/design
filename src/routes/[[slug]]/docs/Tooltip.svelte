...
<p>
    By default, the maximum width of the tooltip is set to <code>300px</code>. If the text is longer than this, it will wrap to the next line. You can change this value by setting the <code>maxWidth</code> prop.
</p>
