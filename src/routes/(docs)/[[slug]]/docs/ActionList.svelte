...
<p>
    Action List is a list of actions. It is primarily used with <a href="dropdown">Dropdowns</a>. There are few components that helps to build an action list.
</p>
...
<Table columns="2fr 2fr 4fr">
    ...
    <TableRow>
        ...
        <div>
            Whether the item is selected or not. Only works when the <code>selection</code> property of the <code>{"<ActionList>"}</code> is set.
        </div>
    </TableRow>
...
<p>
    A <code>select</code> event is emitted when the item is clicked/selected. See the examples below.
</p>
...
<Table columns="1fr 3fr">
    ...
    <TableRow>
        ...
        <div>
            The description of the action list item. See <a href="#descriptions">Descriptions</a>.
        </div>
    </TableRow>
...
<Table columns="2fr 2fr 4fr">
    ...
    <TableRow>
        ...
        <div><code>none</code></div>
        <div>
            Override the selection mode of the <code>{"<ActionList>"}</code> component. One of:
            <ul>
                <li><code>none</code></li>
                <li><code>single</code></li>
                <li><code>multi</code></li>
...
<p>
    For single selections, set <code>selection="single"</code> in the <code>{"<ActionList>"}</code> component. Then, use the <code>selected</code> property and the <code>on:select</code> events of the <code>{"<ActionListItem>"}</code> component to manage the selected item.
</p>
...
<p>
    For multi selections, set <code>selection="multi"</code> in the <code>{"<ActionList>"}</code> component.
</p>
...
<p>
    Use the <code>{"<ActionListGroup>"}</code> component to group items. You can also set a title and a divider for the group.
</p>
...
<p>
    You can also use the <code>selection</code> property in the <code>{"<ActionListGroup>"}</code> component to set the selection mode for only the items in the group.
</p>
...
<CodeResult white>
    <ActionList>
        <ActionListGroup title="Single" selection="single">
            <ActionListItem selected={x3 === 1} on:select={() => x3 = 1}>Option 1</ActionListItem>
            <ActionListItem selected={x3 === 2} on:select={() => x3 = 2}>Option 2</ActionListItem>
        </ActionListGroup>
