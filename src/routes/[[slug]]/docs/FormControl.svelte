...
<p>
    These components are used in the <a href="/split-control">Split Control</a> component along with other components like <a href="/text-input">Text Input</a>, <a href="/checkbox">Checkbox</a>, etc.
</p>
...
<p>
    The <code>{"<FormControl>"}</code> component can be used to wrap label, caption, validation, and other inputs. It will automatically add spacing between the elements.
</p>
