...
<p>
	<code>{'<Radio>'}</code> is a form control that allows users to select one option from a list of
	options. All properties are sent directly to the underlying HTML
	<code>{'<input type="radio">'}</code>
	element.
	<code>bind:group</code>
	can be used to set the current value. The
...
<CodeResult>
	<SplitControl label="Hosted at" caption="Where to host your blog">
		<InputGroup>
