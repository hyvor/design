...
<p>
	The <code>IconButton</code> component can be used to create a button with an icon.
</p>
	...
	<TableRow>
		...
		<div>
			...
			<ul>
				...
				<li>
					<code>input</code>
					<Text small>(fill and invisible only)</Text>
				</li>
...
<CodeResult gap={8}>
	<IconButton as="a" href="https://hyvor.com" target="_blank"><IconBoxArrowUpRight /></IconButton>
</CodeResult>
...
<CodeResult white>
	<IconButton variant="fill" color="red" disabled>
		<IconSearch />
	</IconButton>
</CodeResult>
