...
export class InternationalizationService<
  StringsT extends I18nStrings = I18nStrings,
> {
  ...
  constructor(languages: Language[]) {
    ...
    const defaultStrings =
      (defaultLanguage as LanguageWithStrings).strings || null;
    ...
    this.localeLanguage = derived(
      this.locale,
      ($locale) => this.languageByCode($locale)!,
    );
