...
<Table columns="1fr 3fr">
    ...
    <TableRow>
        ...
        <div>
            To nest split controls inside of other split controls. See <a href="#nested">Nested Split Controls</a> below.
        </div>
    </TableRow>
...
<p>
    You can use slots for the label and caption if you need to add more complex content. <code>&lt;Label&gt;</code> and <code>&lt;Caption&gt;</code> components (see <a href="/form-control">Form Control</a>) or any other element/component can be used in the slots.
</p>
...
<p>
    You can nest split controls inside of other split controls by adding nested content inside the <code>nested</code> slot. The parent split control may or may not have a control on the right side. The nested split controls will be indented.
</p>
