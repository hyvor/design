...
<p>
	The <code>{'<Tag>'}</code> component is used to display a a category, a label, or a status.
</p>
...
<p>Start and end slots can be used to add icons or other elements to the tag.</p>
